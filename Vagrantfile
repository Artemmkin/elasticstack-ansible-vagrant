...
Vagrant.configure("2") do |config|
  config.vm.define "elk" do |elk|
    ...
    elk.vm.synced_folder "elastic-stack-showcase/", "/opt/elastic-stack-showcase/"
    ...
    elk.vm.provision "ansible_local" do |ansible|
      ansible.playbook = "/opt/elastic-stack-showcase/elk.yml"
      #  ansible.verbose = "vvv"
    end
  end
  ...
  config.vm.define "web" do |web|
    ...
    web.vm.synced_folder "elastic-stack-showcase/", "/opt/elastic-stack-showcase/"
    ...
    web.vm.provision "ansible_local" do |ansible|
      ansible.playbook = "/opt/elastic-stack-showcase/web.yml"
      #  ansible.verbose = "vvv"
    end
  end
end
